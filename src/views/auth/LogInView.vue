...
const login = handleSubmit(async ({ email, password }, { resetForm }) => {
...
<template>
  <app-card class="mt-12 shadow-md shadow-slate-600">
    <form class=" p-8 rounded-lg  " @submit.prevent="login" novalidate>
      <h2 class="text-2xl font-semibold mb-6 text-center uppercase">Login</h2>
